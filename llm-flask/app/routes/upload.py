...
from app.extensions.beans import local_storage, name_k2e_convertor, faiss
...
def upload_pdf():
    ...
    need_vertically_split = need_vertically_split == "True"
...
@upload_bp.route("/reload", methods=["GET"])
def reload_index():
    faiss.reload_index()
