...
def embed(text_embedder: TextEmbedder):
    ...
    pdf_path = cur_dir_path / "2025 국민의힘 정책공약집 중앙.pdf"
    ...
    embedder.embed(merge=False, prefix="passge: ")

    # 시도(광역) 공약 임베딩
    sido_pdf_path = cur_dir_path / "2025 국민의힘 정책공약집 시도 (1).pdf"
...
def embed_test(text_embedder: TextEmbedder, query: str):
    index_name = "resources/indexes/peoplepowerparty_kimmoonsoo_index"
